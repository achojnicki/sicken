...
from transformers import BertConfig, AutoTokenizer, AutoModelForCausalLM, Trainer, TrainingArguments
from argparse import ArgumentParser

from constants import BERT_Trainer_Constants
...
class BERT_Trainer:
	def __init__(self):
		self.constants=BERT_Trainer_Constants
