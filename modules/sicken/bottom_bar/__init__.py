...
class Bottom_Bar_GUI(wx.Frame):
	def __init__(self, root):
		...
		wx.Frame.__init__(self, None, title="sicken-bottom_bar", size=(self._config.window.width,self._config.window.height), style=wx.DEFAULT_FRAME_STYLE|wx.BORDER_NONE)
