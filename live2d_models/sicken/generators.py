...
class generators(Animation_Seq):
	...
	def _generate_speak_range_form(self, words, data):
		seq=[]
		for word_index in range(0,len(words)):
			frame=self._frame
			print(words[word_index]['word'])
	...
	def _generate_cat_ears_range(self, start, stop, step):
		l=list(range(start,stop,step))
	...
	def _generate_sun_range(self, start, stop, step):
		l=list(range(start,stop,-step))
	...
	def _generate_cloud_range(self, start, stop, step):
		l=list(range(start,stop,-step))
